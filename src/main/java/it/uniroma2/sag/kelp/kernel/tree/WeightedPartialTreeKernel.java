...
/*
	 ...
	 */
	@JsonTypeName("wptk")
	public class WeightedPartialTreeKernel extends DirectKernel<TreeRepresentation> {

		private Logger logger = LoggerFactory.getLogger(WeightedPartialTreeKernel.class);
		...
		private StructureElementSimilarityI nodeSimilarity = null;
		 ...
		 * in your application.
		 */
		public WeightedPartialTreeKernel() {
			this(0.4f, 0.4f, 1f, "0");
		}
		 ...
		 */
		public WeightedPartialTreeKernel(float LAMBDA, float MU, float terminalFactor,
		 ...
		 */
		public WeightedPartialTreeKernel(String representationIdentifier) {
		 ...
		 */
		protected ArrayList<TreeNodePairs> determineSubList(TreeRepresentation a,
		 ...
		 * @return
		 */
		protected float ptkDeltaFunction(TreeNode Nx, TreeNode Nz) {
			float sum = 0;
		 ...
		 */
		protected float stringKernelDeltaFunction(ArrayList<TreeNode> Sx,
